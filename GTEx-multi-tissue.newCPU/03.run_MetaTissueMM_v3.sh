TH="/home/omics/DATA_CPU/haeun/stemness/data/TCGA-TARGET-GTEx/GTEx-mutli-tissue"
FILE_PATH="/home/omics/DATA_CPU/haeun/stemness"
export FILE_PATH

parallel --env FILE_PATH --eta -j 40 --load 80% --xapply --noswap '/home/omics/haeun/program/MetaTissueMM \
...
--n_digits 5 \
--full_metasoft_output \
--savebeta \
--start_snp_index {1} \
--end_snp_index {2}' ::: {400000..7980000..10000} ::: {410000..7990000..10000}
